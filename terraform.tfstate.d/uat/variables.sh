...
export VAULT_SA_NAME=$(kubectl get sa -n jx-uat employernotificationapi-vault -o jsonpath="{.secrets[*]['name']}")
...
export TF_VAR_key="uat.terraform.employernotificationapi.tfstate"
